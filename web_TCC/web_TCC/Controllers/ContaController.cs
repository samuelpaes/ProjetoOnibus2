    ...
    public class ContaController : Controller
    {
       private web_TCCContext db = new web_TCCContext();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(model.Email, model.Password, Convert.ToBoolean(model.RememberMe), shouldLockout: false);
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "Tentativa inválida.");
                    return View(model);
            }
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> EsqueciASenha(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null || !(await UserManager.IsEmailConfirmedAsync(user.Id)))
                {
                    ...
                    return View("EsqueciASenhaConfirmacao");
                }
        ...
        [AllowAnonymous]
        public ActionResult EsqueciASenhaConfirmacao()
        {
            return View();
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ResetarSenha(ResetPasswordViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
